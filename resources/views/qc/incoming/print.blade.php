...
<div class="box">
    <div class="header"><div>@if($company->logo_path)<img src="{{ asset($company->logo_path) }}" style="max-height:60px;object-fit:contain" alt="Logo">@endif</div><div style="text-align:right"><div class="doc-title-box"><div class="doc-title">INCOMING INSPECTION</div><div style="font-size:9px;letter-spacing:1px">LAPORAN PEMERIKSAAN BARANG MASUK</div></div><div style="font-size:13px;font-weight:bold;margin-top:8px">{{ $qc->qc_number }}</div></div></div>
