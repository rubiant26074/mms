        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ $isEdit ? route('warehouse.items.update', $item) : route('warehouse.items.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3"><label>Satuan</label><input type="text" name="unit" class="form-control" value="{{ old('unit', $item->unit) }}" required placeholder="Pcs, Kg, Set"></div>
                        <div class="col-md-3 mb-3"><label class="fw-bold text-primary">Stok Awal (Qty)</label><input type="number" step="any" min="0" name="current_stock" class="form-control border-primary fw-bold text-end" value="{{ old('current_stock', $item->current_stock + 0) }}"></div>
